...
--
-- Base de données : `betterconnectiong1_exemple`
--
DROP DATABASE IF EXISTS `betterconnectiong1_exemple`;
CREATE DATABASE IF NOT EXISTS `betterconnectiong1_exemple` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `betterconnectiong1_exemple`;
