...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : ven. 22 mars 2024 à 05:52
...
CREATE DATABASE IF NOT EXISTS `betterconnectiong1` DEFAULT CHARACTER SET utf8mb3 COLLATE utf8mb3_general_ci;
...
--
ALTER TABLE `news`
    ADD CONSTRAINT `fk_news_user1` FOREIGN KEY (`user_iduser`) REFERENCES `user` (`iduser`);
